...
class CNC_Machine:
    ...
    def __init__(self, port: str, baud: int, location_file: str, virtual: bool = False):
        """
        :param port: serial port for CNC
        :param baud: baud rate for CNC
        :param location_file: path to YAML file with location grid
        :param virtual: if True, simulate movements
        """
        ...
        print(f"Connected to CNC Machine! (virtual={self.VIRTUAL}, port={self.SERIAL_PORT}, baud={self.BAUD_RATE})")
